...
var Slider = React.createClass({
  ...
  setValue: function(value: number) {
    if (!this.state.sliding) {
      if (this.props.maximumValue - value < 1) {
        this.setState({value: this.props.maximumValue});
      } else {
  ...
  _handlePanResponderGrant: function(e: Object, gestureState: Object) {
    this.setState({ sliding: true, previousLeft: this._getThumbLeft(this.state.value) });
  },
  ...
  _handlePanResponderEnd: function(e: Object, gestureState: Object) {
    this.setState({ sliding: false, value: this._getValue(gestureState) },
