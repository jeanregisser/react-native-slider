...
pointerEvents:"none",__source:{fileName:_jsxFileName,lineNumber:508}}));


},_this.

_renderThumbText=function(){var _this$props=
_this.props,thumbText=_this$props.thumbText,thumbTextStyle=_this$props.thumbTextStyle;

if(!thumbText)return;
if(!thumbTextStyle)thumbTextStyle={};
return(
_react2.default.createElement(_reactNative.View,{style:{flex:1,justifyContent:'center',alignItems:'center'},__source:{fileName:_jsxFileName,lineNumber:521}},
_react2.default.createElement(_reactNative.Text,{style:[thumbTextStyle,{backgroundColor:'transparent'}],__source:{fileName:_jsxFileName,lineNumber:522}},thumbText)));
